var saaa_notify_message = new function()
{
	this.title = null;
	this.message = null;
	this.showtime = 30;
...
var saaa_notifier = function(){
	this.messages = new Array();
	
};
saaa_notifier.prototype.init = function(){};
saaa_notifier.prototype.add = function(saaa_notify_message){};
saaa_notifier.prototype._adjust_window = function(){
	this.html_loader.stage.nativeWindow.height = this.messageList.length * this.messageHeight;		
};
var mynotifier = 
{
	messages: new Array(),
...
air.trace(air.Capabilities.os );
		var bounds = new air.Rectangle(
			...
			visibleBounds.bottom -  ( mynotifier.height + mynotifier.margin + ((air.Capabilities.os.toLowerCase().indexOf("windows") != -1)? 0 : 40)), /* top */ 
